...
banned_words = [
    ...
    "kefo", "khontkar", "la la la !", "lvbel c5", "mero", "mini terorista", "motive", 
    "murda", "no cap", "no.1", "o adam", "organize", "organıze", "pişt", 
...
def get_matching_windows(open_windows):
    ...
    for window in open_windows:
        if any(banned_word.lower() in window.lower() for banned_word in banned_words):
            if not any(app.lower() in window.lower() for app in system_apps):
